...
func EncodeSayRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*africastalking.SayPayload)
		if !ok {
			return goahttp.ErrInvalidType("africastalking", "Say", "*africastalking.SayPayload", v)
		}
...
func EncodePlayRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*africastalking.PlayPayload)
		if !ok {
			return goahttp.ErrInvalidType("africastalking", "Play", "*africastalking.PlayPayload", v)
		}
...
func EncodeGetDigitsRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*africastalking.GetDigitsPayload)
		if !ok {
			return goahttp.ErrInvalidType("africastalking", "GetDigits", "*africastalking.GetDigitsPayload", v)
		}
...
func EncodeDialRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*africastalking.DialPayload)
		if !ok {
			return goahttp.ErrInvalidType("africastalking", "Dial", "*africastalking.DialPayload", v)
		}
...
func EncodeRecordRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*africastalking.RecordPayload)
		if !ok {
			return goahttp.ErrInvalidType("africastalking", "Record", "*africastalking.RecordPayload", v)
		}
...
func EncodeEnqueueRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*africastalking.EnqueuePayload)
		if !ok {
			return goahttp.ErrInvalidType("africastalking", "Enqueue", "*africastalking.EnqueuePayload", v)
		}
...
func EncodeDequeueRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*africastalking.DequeuePayload)
		if !ok {
			return goahttp.ErrInvalidType("africastalking", "Dequeue", "*africastalking.DequeuePayload", v)
		}
...
func EncodeRedirectRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*africastalking.RedirectPayload)
		if !ok {
			return goahttp.ErrInvalidType("africastalking", "Redirect", "*africastalking.RedirectPayload", v)
		}
...
func EncodeRejectRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*africastalking.RejectPayload)
		if !ok {
			return goahttp.ErrInvalidType("africastalking", "Reject", "*africastalking.RejectPayload", v)
		}
