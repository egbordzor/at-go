...
// FindTransactionResponse is the viewed result type that is projected based on
// a view.
type FindTransactionResponse struct {
	// Type to project
	Projected *FindTransactionResponseView
	// View to render
	View string
}

// ProductTransactionsResponse is the viewed result type that is projected
// based on a view.
type ProductTransactionsResponse struct {
	// Type to project
	Projected *ProductTransactionsResponseView
	// View to render
	View string
}

// WalletTransactionsResponse is the viewed result type that is projected based
// on a view.
type WalletTransactionsResponse struct {
	// Type to project
	Projected *WalletTransactionsResponseView
	// View to render
	View string
}

// WalletBalanceResponse is the viewed result type that is projected based on a
// view.
type WalletBalanceResponse struct {
	// Type to project
	Projected *WalletBalanceResponseView
	// View to render
	View string
}
...
// FindTransactionResponseView is a type that runs validations on a projected
// type.
type FindTransactionResponseView struct {
	// Status of the request
	Status *string
	// Details of the transaction.
	Data *TransactionResponseView
	// A message detailing what happened with a failed request.
	ErrorMessage *string
}

// TransactionResponseView is a type that runs validations on a projected type.
...
// ProductTransactionsResponseView is a type that runs validations on a
// projected type.
type ProductTransactionsResponseView struct {
	// The status of the request.
	Status    *string
	Responses []*TransactionResponseView
}

// WalletTransactionsResponseView is a type that runs validations on a
// projected type.
type WalletTransactionsResponseView struct {
	// The status of the request
	Status *string
	// List of response Entry corresponding to a transaction result.
	Responses []*WalletEntryView
	// A message detailing what happened with a failed request.
	ErrorMessage *string
}

// WalletEntryView is a type that runs validations on a projected type.
type WalletEntryView struct {
	...
	TransactionData FindTransactionResponseCollectionView
	// Value being exchanged in this transaction.
	Value *string
...
// FindTransactionResponseCollectionView is a type that runs validations on a
// projected type.
type FindTransactionResponseCollectionView []*FindTransactionResponseView

// WalletBalanceResponseView is a type that runs validations on a projected
// type.
type WalletBalanceResponseView struct {
	// The status of the request.
	Status *string
...
var (
	...
	// FindTransactionResponseMap is a map of attribute names in result type
	// FindTransactionResponse indexed by view name.
	FindTransactionResponseMap = map[string][]string{
		"default": []string{
			"status",
			"data",
			"errorMessage",
	...
	// ProductTransactionsResponseMap is a map of attribute names in result type
	// ProductTransactionsResponse indexed by view name.
	ProductTransactionsResponseMap = map[string][]string{
		"default": []string{
			"status",
			"responses",
		},
	}
	// WalletTransactionsResponseMap is a map of attribute names in result type
	// WalletTransactionsResponse indexed by view name.
	WalletTransactionsResponseMap = map[string][]string{
		"default": []string{
			"status",
			"responses",
			"errorMessage",
	...
	// WalletBalanceResponseMap is a map of attribute names in result type
	// WalletBalanceResponse indexed by view name.
	WalletBalanceResponseMap = map[string][]string{
		"default": []string{
			"status",
			"balance",
			"errorMessage",
	...
	// FindTransactionResponseCollectionMap is a map of attribute names in result
	// type FindTransactionResponseCollection indexed by view name.
	FindTransactionResponseCollectionMap = map[string][]string{
		"default": []string{
			"status",
			"data",
			"errorMessage",
...
// ValidateFindTransactionResponse runs the validations defined on the viewed
// result type FindTransactionResponse.
func ValidateFindTransactionResponse(result *FindTransactionResponse) (err error) {
	switch result.View {
	case "default", "":
		err = ValidateFindTransactionResponseView(result.Projected)
	default:
		err = goa.InvalidEnumValueError("view", result.View, []interface{}{"default"})
	}
	return
...
// ValidateProductTransactionsResponse runs the validations defined on the
// viewed result type ProductTransactionsResponse.
func ValidateProductTransactionsResponse(result *ProductTransactionsResponse) (err error) {
	switch result.View {
	case "default", "":
		err = ValidateProductTransactionsResponseView(result.Projected)
	default:
		err = goa.InvalidEnumValueError("view", result.View, []interface{}{"default"})
	}
	return
...
// ValidateWalletTransactionsResponse runs the validations defined on the
// viewed result type WalletTransactionsResponse.
func ValidateWalletTransactionsResponse(result *WalletTransactionsResponse) (err error) {
	switch result.View {
	case "default", "":
		err = ValidateWalletTransactionsResponseView(result.Projected)
	default:
		err = goa.InvalidEnumValueError("view", result.View, []interface{}{"default"})
	}
	return
...
// ValidateWalletBalanceResponse runs the validations defined on the viewed
// result type WalletBalanceResponse.
func ValidateWalletBalanceResponse(result *WalletBalanceResponse) (err error) {
	switch result.View {
	case "default", "":
		err = ValidateWalletBalanceResponseView(result.Projected)
	default:
		err = goa.InvalidEnumValueError("view", result.View, []interface{}{"default"})
	}
	return
...
// ValidateFindTransactionResponseView runs the validations defined on
// FindTransactionResponseView using the "default" view.
func ValidateFindTransactionResponseView(result *FindTransactionResponseView) (err error) {
	if result.Status != nil {
		if !(*result.Status == "Success" || *result.Status == "Failed") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.status", *result.Status, []interface{}{"Success", "Failed"}))
		}
	...
	if result.Data != nil {
		if err2 := ValidateTransactionResponseView(result.Data); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	return
...
// ValidateTransactionResponseView runs the validations defined on
// TransactionResponseView.
func ValidateTransactionResponseView(result *TransactionResponseView) (err error) {
	for k, v := range result.RequestMetadata {
		err = goa.MergeErrors(err, goa.ValidatePattern("result.requestMetadata.key", k, "[a-zA-Z]+"))
		err = goa.MergeErrors(err, goa.ValidatePattern("result.requestMetadata[key]", v, "[a-zA-Z]+"))
	}
	if result.SourceType != nil {
		if !(*result.SourceType == "PhoneNumber" || *result.SourceType == "BankAccount" || *result.SourceType == "Card" || *result.SourceType == "Wallet") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.sourceType", *result.SourceType, []interface{}{"PhoneNumber", "BankAccount", "Card", "Wallet"}))
		}
	}
	if result.Provider != nil {
		if !(*result.Provider == "Mpesa" || *result.Provider == "Segovia" || *result.Provider == "Flutterwave" || *result.Provider == "Admin" || *result.Provider == "Athena") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.provider", *result.Provider, []interface{}{"Mpesa", "Segovia", "Flutterwave", "Admin", "Athena"}))
		}
	}
	if result.DestinationType != nil {
		if !(*result.DestinationType == "phoneNumber" || *result.DestinationType == "BankAccount" || *result.DestinationType == "Card" || *result.DestinationType == "Wallet") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.destinationType", *result.DestinationType, []interface{}{"phoneNumber", "BankAccount", "Card", "Wallet"}))
		}
	}
	for k, v := range result.ProviderMetadata {
		err = goa.MergeErrors(err, goa.ValidatePattern("result.providerMetadata.key", k, "[a-zA-Z]+"))
		err = goa.MergeErrors(err, goa.ValidatePattern("result.providerMetadata[key]", v, "[a-zA-Z]+"))
	}
	if result.Status != nil {
		if !(*result.Status == "Success" || *result.Status == "Failed") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.status", *result.Status, []interface{}{"Success", "Failed"}))
	...
	if result.Category != nil {
		if !(*result.Category == "BankCheckout" || *result.Category == "CardCheckout" || *result.Category == "MobileCheckout" || *result.Category == "MobileC2B" || *result.Category == "MobileB2C" || *result.Category == "MobileB2B" || *result.Category == "BankTransfer" || *result.Category == "WalletTransfer" || *result.Category == "UserStashTopup") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.category", *result.Category, []interface{}{"BankCheckout", "CardCheckout", "MobileCheckout", "MobileC2B", "MobileB2C", "MobileB2B", "BankTransfer", "WalletTransfer", "UserStashTopup"}))
		}
	}
	...
	if result.CreationTime != nil {
		err = goa.MergeErrors(err, goa.ValidateFormat("result.creationTime", *result.CreationTime, goa.FormatDateTime))
	}
	return
}

// ValidateProductTransactionsResponseView runs the validations defined on
// ProductTransactionsResponseView using the "default" view.
func ValidateProductTransactionsResponseView(result *ProductTransactionsResponseView) (err error) {
	if result.Status != nil {
		if !(*result.Status == "Success" || *result.Status == "Failed") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.status", *result.Status, []interface{}{"Success", "Failed"}))
		}
	...
	for _, e := range result.Responses {
		if e != nil {
			if err2 := ValidateTransactionResponseView(e); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	}
...
// ValidateWalletTransactionsResponseView runs the validations defined on
// WalletTransactionsResponseView using the "default" view.
func ValidateWalletTransactionsResponseView(result *WalletTransactionsResponseView) (err error) {
	if result.Status != nil {
		if !(*result.Status == "Success" || *result.Status == "Failed") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.status", *result.Status, []interface{}{"Success", "Failed"}))
		}
	...
	for _, e := range result.Responses {
		if e != nil {
			if err2 := ValidateWalletEntryView(e); err2 != nil {
				err = goa.MergeErrors(err, err2)
			}
		}
	}
...
// ValidateWalletEntryView runs the validations defined on WalletEntryView.
func ValidateWalletEntryView(result *WalletEntryView) (err error) {
	if result.Category != nil {
		if !(*result.Category == "BankCheckout" || *result.Category == "CardCheckout" || *result.Category == "MobileCheckout" || *result.Category == "MobileC2B" || *result.Category == "MobileB2C" || *result.Category == "MobileB2B" || *result.Category == "BankTransfer" || *result.Category == "WalletTransfer" || *result.Category == "UserStashTopup") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.category", *result.Category, []interface{}{"BankCheckout", "CardCheckout", "MobileCheckout", "MobileC2B", "MobileB2C", "MobileB2B", "BankTransfer", "WalletTransfer", "UserStashTopup"}))
		}
	}
	if err2 := ValidateFindTransactionResponseCollectionView(result.TransactionData); err2 != nil {
		err = goa.MergeErrors(err, err2)
	}
	return
}

// ValidateFindTransactionResponseCollectionView runs the validations defined
// on FindTransactionResponseCollectionView using the "default" view.
func ValidateFindTransactionResponseCollectionView(result FindTransactionResponseCollectionView) (err error) {
	for _, item := range result {
		if err2 := ValidateFindTransactionResponseView(item); err2 != nil {
			err = goa.MergeErrors(err, err2)
		}
	}
	return
...
// ValidateWalletBalanceResponseView runs the validations defined on
// WalletBalanceResponseView using the "default" view.
func ValidateWalletBalanceResponseView(result *WalletBalanceResponseView) (err error) {
	if result.Status != nil {
		if !(*result.Status == "Success" || *result.Status == "Failed") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("result.status", *result.Status, []interface{}{"Success", "Failed"}))
		}
